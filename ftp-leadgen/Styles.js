 ...
 *
 * Brand palette (from Steve, 2026-03-24):
 *   --purple  #361852  (primary bg)
 *   --gold    #b39062  (accent)
 *   --black   #000000
 *   --white   #ffffff
 */
  ...
  getBase() {
    return `
      ...
      *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
      ...
      h3 { font-size: 18px; margin-bottom: 10px; color: var(--gold); }
      ...
      select {
        ...
        border: 1px solid rgba(179,144,98,0.4);
        border-radius: 8px;
        color: var(--text);
        font-family: 'Rubik', sans-serif;
        font-size: 15px;
      ...
      input:focus, select:focus { border-color: var(--gold); box-shadow: 0 0 0 3px rgba(179,144,98,0.15); }
      input::placeholder { color: var(--muted); }

      select option { background: #26103d; color: var(--text); }
      ...
      .progress-fill {
        height: 100%;
        background: linear-gradient(90deg, #6b3a9e, var(--gold));
        border-radius: 4px;
      ...
      .spinner {
        ...
        border: 4px solid rgba(179,144,98,0.2);
