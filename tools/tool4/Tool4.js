...
<body>
  ...
  // ============================================================================
  // SCORING FUNCTIONS — Extracted to Tool4Scoring.js
  // All 10 priority scoring functions (scoreWealthPriority, scoreDebtPriority,
  // etc.) are now in Tool4Scoring.js for maintainability.
  // Called via Tool4Scoring.scoreXPriority(data) from calculatePriorityRecommendations().
  // ============================================================================

  /**
   * REMOVED — Now in Tool4Scoring.js
    ...
    const priorities = [
      {
        ...
        score: Tool4Scoring.scoreWealthPriority({ discipline, longTerm, debtLoad, incomeStability, growth, emergencyFund, autonomy, lifestyle, essentialsPct, surplus }),
        baseAllocation: { M:40, E:25, F:20, J:15 }
      },
      {
        name: 'Get Out of Debt',
        score: Tool4Scoring.scoreDebtPriority({ debtLoad, interestLevel, satisfaction, stability, emergencyFund, lifestyle, essentialsPct, surplus }),
        baseAllocation: { M:15, E:25, F:45, J:15 }
      },
      {
        name: 'Feel Financially Secure',
        score: Tool4Scoring.scoreSecurityPriority({ incomeStability, emergencyFund, dependents, satisfaction, stability, impulse, discipline, growth, essentialsPct, surplus }),
        baseAllocation: { M:25, E:35, F:30, J:10 }
      },
      {
        name: 'Enjoy Life Now',
        score: Tool4Scoring.scoreEnjoymentPriority({ satisfaction, lifestyle, incomeStability, debtLoad, emergencyFund, impulse, incomeRange, dependents, essentialsPct, surplus }),
        baseAllocation: { M:20, E:20, F:15, J:45 }
      },
      {
        name: 'Save for a Big Goal',
        score: Tool4Scoring.scoreBigGoalPriority({ debtLoad, emergencyFund, discipline, incomeStability, essentialsPct, surplus }),
        baseAllocation: { M:15, E:25, F:45, J:15 }
      },
      {
        name: 'Stabilize to Survive',
        score: Tool4Scoring.scoreSurvivalPriority({ debtLoad, incomeStability, emergencyFund, dependents, satisfaction, incomeRange, essentialsPct, surplus }),
        baseAllocation: { M:5, E:45, F:40, J:10 }
      },
      {
        name: 'Build or Stabilize a Business',
        score: Tool4Scoring.scoreBusinessPriority({ autonomy, growth, emergencyFund, incomeStability, discipline, debtLoad, dependents, essentialsPct, surplus }),
        baseAllocation: { M:20, E:30, F:35, J:15 }
      },
      {
        name: 'Create Generational Wealth',
        score: Tool4Scoring.scoreGenerationalPriority({ incomeRange, growth, discipline, emergencyFund, debtLoad, longTerm, dependents, essentialsPct, surplus }),
        baseAllocation: { M:45, E:25, F:20, J:10 }
      },
      {
        name: 'Create Life Balance',
        score: Tool4Scoring.scoreBalancePriority({ satisfaction, lifestyle, incomeStability, debtLoad, emergencyFund, essentialsPct, surplus }),
        baseAllocation: { M:15, E:25, F:25, J:35 }
      },
      {
        name: 'Reclaim Financial Control',
        score: Tool4Scoring.scoreControlPriority({ satisfaction, debtLoad, discipline, emergencyFund, incomeStability, impulse, essentialsPct, surplus }),
 ...
 * Called by: Pre-survey form submission (buildUnifiedPage)
 */
