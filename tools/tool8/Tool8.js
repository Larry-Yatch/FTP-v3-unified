...
const Tool8 = {
  ...
  buildPage(clientId) {
    ...
    // Load CSS: shared base → calculator shared → tool 8 specific
    var sharedStyles = HtmlService.createHtmlOutputFromFile('shared/styles').getContent();
    var calculatorStyles = HtmlService.createHtmlOutputFromFile('shared/calculator-styles').getContent();
    var tool8Styles = HtmlService.createHtmlOutputFromFile('tools/tool8/tool8-styles').getContent();
